        ...
        <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-8-x xl:space-y-0">
          <div className="flex flex-col items-center pt-8">
            ...
            <div className="flex space-x-5 pt-4">
              ...
              {/*idk Link */}
              <a href="ailto:timdube0@gmail.com">
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="w-8 h-8 text-teal-500 hover:text-teal-600"
          ...
          <div className="prose max-w-none prose-lg pt-8 pb-7 sm:px-4 sm:text-center dark:prose-invert xl:col-span-2">
            ...
            <p>
              ...
              , I&apos;ve developed a strong foundation in programming and a
              deep understanding of various programming languages, including{" "}
              <span className="font-bold text-teal-400 dark:text-blue-500">
                Python, Java, and C.
              </span>{" "}
              My journey in computer science is marked by a constant eagerness
              to learn and a commitment to enhancing my skills through robust
              coding projects.
            </p>
            <p>
              ...
              challenges, I approach them with a blend of analytical thinking
              and creativity. This approach has not only helped me in
              successfully navigating through complex programming tasks but also
              in contributing effectively to team projects and collaborative
              school assignments.
            </p>
          </div>
        </div>
